...
import { LayoutDashboard, Users, Building2, Briefcase, Tag, DollarSign, AlertTriangle, Settings, ShieldCheck, Bell, BarChart3, UserCheck, Wrench, Building, FileEdit } from 'lucide-react';
...
const sidebarItems = [
  ...
  { label: 'Worker Management', labelKey: 'nav.adminWorkerManagement', href: '/admin/worker-management', icon: Wrench },
  { label: 'Employer Management', labelKey: 'nav.adminEmployerManagement', href: '/admin/employer-management', icon: Building },
  ...
  { label: 'Advanced Analytics', labelKey: 'adminAnalytics.title', href: '/admin/advanced-analytics', icon: BarChart3 },
  ...
  { label: 'Content Management', labelKey: 'nav.adminContentManagement', href: '/admin/content-management', icon: FileEdit },
];
